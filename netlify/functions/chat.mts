// Netlify Function: /api/chat  (ported from Express server.ts, logic unchanged)
// Keeps GEMINI_API_KEY server-side. Falls back to generateLocalExplanation offline.
...
export default async (req: Request): Promise<Response> => {
  ...
  const { message, context, step } = body || {};
